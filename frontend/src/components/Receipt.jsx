  ...
  return (
    <>
      <div>
        ...
        <div className='max-w-md mx-auto text-left bg-white text-black p-4 shadow-xl font-mono'>
          <div className="flex justify-center gap-4 mt-4">
            <button onClick={handleDownload} className="text-sm underline">⬇️ Download</button>
            <button onClick={() => { setShow(false) }} className="text-sm underline">⬅️ Generate More</button>
